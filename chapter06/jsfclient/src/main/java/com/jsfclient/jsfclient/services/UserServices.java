...
// <editor-fold defaultstate="collapsed" desc="List<User> findAll()">
    public List<User> findAll() {
        List<User> jsdusuarioList = new ArrayList<>();
        try {
            ...
            jsdusuarioList = target.request(MediaType.APPLICATION_JSON).get(data);

        } catch (Exception e) {
         
            System.out.println("findAll()" + e.getLocalizedMessage());
        }
        return jsdusuarioList;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Boolean add(User jsdusuario)">
    public Boolean add(User jsdusuario) {
        try {
            Client client = ClientBuilder.newClient();
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
            ...
            Response response = invocationBuilder.post(Entity.entity(jsdusuario, MediaType.APPLICATION_JSON));
...
// </editor-fold>
    ...
    public Boolean uodate(User jsdusuario) {
        try {
            Client client = ClientBuilder.newClient();
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
